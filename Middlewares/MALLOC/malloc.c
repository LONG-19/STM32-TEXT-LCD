 ...
 * @version     V1.0
 * @date        2022-09-06
static __align(64) uint8_t mem2base[MEM2_MAX_SIZE] __attribute__((at(MEM2_BASE_ADDR)));                           /* ⲿSDRAMڴ,Ԥ˫֡ʾ */
static MT_TYPE mem2mapbase[MEM2_ALLOC_TABLE_SIZE] __attribute__((at(MEM2_BASE_ADDR + MEM2_MAX_SIZE)));            /* ⲿSDRAMڴMAP */
static __ALIGNED(64) uint8_t mem2base[MEM2_MAX_SIZE] __attribute__((at(MEM2_BASE_ADDR)));                           /* ⲿSDRAMڴ,Ԥ˫֡ʾ */
static MT_TYPE mem2mapbase[MEM2_ALLOC_TABLE_SIZE] __attribute__((at(MEM2_BASE_ADDR + MEM2_MAX_SIZE)));            /* ڲCCMڴMAP */
 *
