...
void ltdc_set_draw_buffer(uint8_t backbuf);                                                   /* select drawing buffer */
uint8_t ltdc_get_back_buffer(void);                                                       /* query back buffer */
void ltdc_flip_buffers(void);                                                             /* front/back buffer swap */
