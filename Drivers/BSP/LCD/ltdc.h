 ...
 * @date        2022-09-06
typedef struct
    uint8_t frontbuf;     /* ǰʾ֡ */
    uint8_t drawbuf;      /* ǰ֡ */
#if LTDC_PIXFORMAT == LTDC_PIXEL_FORMAT_ARGB8888 || LTDC_PIXFORMAT == LTDC_PIXEL_FORMAT_RGB888
#define LTDC_PIXEL_BYTES         4
#else
#define LTDC_PIXEL_BYTES         2
#endif

#define LTDC_MAX_FRAME_PIXELS    (1280 * 800)
#define LTDC_FRAME_BUF_LEN       (LTDC_MAX_FRAME_PIXELS * LTDC_PIXEL_BYTES)
#define LTDC_FRAME_BUF_ADDR1     LTDC_FRAME_BUF_ADDR
#define LTDC_FRAME_BUF_ADDR2     (LTDC_FRAME_BUF_ADDR1 + LTDC_FRAME_BUF_LEN)
#define LTDC_FRAME_RESERVED_BYTES (LTDC_FRAME_BUF_LEN * 2)

void ltdc_set_draw_buffer(uint8_t bufindex);                                                                    /* ָͼ֡ */
void ltdc_switch_frame(void);                                                                                   /* лǰ֡ */
